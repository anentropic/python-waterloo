...
from .grammars.stackoverflow import grammar
...
def test_stackoverflow():
    example = """identifier: some description text here which will wrap
    on to the next line. the follow-on text should be
...
last_identifier: blah blah"""
    ...
    for i, expected_def in enumerate(expected):
        ...
        assert normalize('\n'.join(parsed_def.description)) == expected_def.description
