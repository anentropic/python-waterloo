...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            TypeAtom(
                "Tuple",
                [TypeAtom("int", []), TypeAtom("str", []), TypeAtom("ClassName", [])],
            ),
        ),
        (
            """Tuple[
...
@pytest.mark.parametrize(
    "example",
    ["Dict[int, str", "Dict[int, [db.models.User]", "Dict[int, [db.models.User]]]"],
)
...
@pytest.mark.parametrize(
    ...
    """,
            TypeDef.from_tuples(
                (2, 12), TypeAtom("Optional", [TypeAtom("float", [])]), (2, 27),
            ),
        ),
        (
            """
    ...
    """,
            TypeDef.from_tuples(
                (3, 12), TypeAtom("Optional", [TypeAtom("float", [])]), (3, 27),
            ),
        ),
        (
            """
    ...
    """,
        ...
        Yield:
            A
    """,
            TypeDef.from_tuples((2, 12), TypeAtom("A", []), (2, 13),),
        ),
    ],
)
